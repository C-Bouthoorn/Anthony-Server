...
/*jshint node: true*///;
'use strict';
var Base64, FILES, HTML, PORT, SERVER_USER, USER_TABLE, WWW_ROOT, app, cmdline, db, fs, htmlencode, http, io, mysql, parseMessage, postlogin, readline, receiveMessage, salthash, sendMessage, sessionid_by_socketid, sessions, sockets, util,
