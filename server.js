...
'use strict';
var Base64, FILES, PORT, USER_TABLE, WWW_ROOT, app, db, fs, http, io, mysql, password, postlogin, sendMessage, sessions, sockets,
...
postlogin = function(socket, user) {
  ...
  return sendMessage('SERVER', "<span class='user'>" + user + "</span> joined us! Yay!");
};
...
io.sockets.on('connection', function(socket) {
  ...
  return socket.on('disconnect', function() {
    ...
    if (indexOf.call(sockets, socket) >= 0) {
      return delete sockets[socket];
    }
  });
});
