...
'use strict';
var channels, checkPass, emojis, escapeRegex, getUsernameCookie, i, init, initchat, len, login, logout, name, parseMessage, ref, register, removeUsernameCookie, safe, sessionid, setUsernameCookie, setstatus, socket;
